...
class ManageBooksForm extends StatefulWidget {
  const ManageBooksForm({Key? key}) : super(key: key);

  @override
  _ManageBooksFormState createState() => _ManageBooksFormState();
}

class _ManageBooksFormState extends State<ManageBooksForm> {
            ...
            DefaultButton(
              ...
              press: () {
                if (_formKey.currentState!.validate()) {
                  ...
                  //     price,
                  //     photo,
                  //     DateFormat.yMd('en_US').parse(publishedDate),
                  //     isFav,
                  //     rating,
                  //     quantity);

                  ApiBookService.editBook(arguments.book.id, bookName,
                          description, price, publishedDate, quantity, photo)
                      .then((response) {
